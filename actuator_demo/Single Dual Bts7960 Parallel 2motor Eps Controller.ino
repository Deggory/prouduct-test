...
// ============================================================
// ESP32 + MCP2515 + ONE BTS7960 BOARD + 2 PARALLEL N25 MOTORS
// Both motors share SAME PWM driver output
// 2 encoders used for average position + mismatch safety
// ============================================================
...
// ============================================================
// CASCADE CONTROLLER USING AVERAGE OF 2 ENCODERS
// ============================================================
int computeCascadePWM() {
  ...
  long avgPos = (encoder1Count + encoder2Count) / 2;
...
// ============================================================
// MOTOR MISMATCH SAFETY
// Since both motors share one driver, correction is impossible.
// So we detect mismatch and disable assist.
// ============================================================
bool encoderMismatchFault() {
  long diff = labs(encoder1Count - encoder2Count);
...
void setup() {
  ...
  Serial.println("Single BTS7960 dual motor EPS ready");
}
