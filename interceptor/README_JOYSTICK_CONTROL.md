...
**Cause:** When disengaging, the ESP32 must send val0=val1=0 (or both equal). Our code sends them as 2048/2048 when magnitude=0, which gives difference=0. If you see this fault, there's a race condition — investigate timing.
